...
<p align="center"><b>LLM &amp; AI tooling · DevOps / Homelab · IT Infrastructure</b></p>
<p align="center">
  ...
  <a href="https://huggingface.co/tacengiz"><img src="https://img.shields.io/badge/Hugging%20Face-FFD21E?logo=huggingface&logoColor=black" alt="Hugging Face"></a>
...
LLM/AI **tooling** ve **self-hosted infrastructure** üzerine üretim yapan bir geliştiriciyim.
**Open-source**, **privacy-first** ve pratik araçlar geliştiriyorum — LLM **VRAM sizing**,
**GitOps** ile LLM bot deployment, Android uygulamaları ve **browser extensions**.
Arka planımda kurumsal IT: **Active Directory**, **Azure** ve **PowerShell** otomasyonu.

Şu sıralar **homelab** (Docker · Traefik · Tailscale) üzerinde **LLM serving** ve self-hosting ile uğraşıyorum.
